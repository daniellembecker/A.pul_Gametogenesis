...
ggsave("RAnalysis/output/HOBO/mean.temp.month.pdf", temp.month , width = 10, height = 6)
ggsave("RAnalysis/output/HOBO/mean.temp.month.jpg", temp.month , width = 10, height = 6)
...
ggsave("RAnalysis/output/HOBO/mean.light.month.jpg", .month , width = 10, height = 6)
