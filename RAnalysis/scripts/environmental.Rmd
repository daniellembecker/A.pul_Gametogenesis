...
```{r}
mahana.temp.hobo.06 <- read.csv("RAnalysis/data/environmental/HOBO_temperature/Mahana_6.csv")
mahana.temp.hobo.09 <- read.csv("RAnalysis/data/environmental/HOBO_temperature/Mahana_9.csv")
mahana.temp.hobo.07 <- read.csv("RAnalysis/data/environmental/HOBO_temperature/20444028_Mahana_7.csv")
...
# save mean temp per month plot
ggsave("RAnalysis/output/environmental/temp_summary_plot.pdf", temp_summary_plot , width = 10, height = 6)
ggsave("RAnalysis/output/environmental/temp_summary_plot.jpg", temp_summary_plot , width = 10, height = 6)
...
ggsave("RAnalysis/output/environmental/light_summary_plot.jpg", light_summary_plot , width = 10, height = 6)
```
...
light.temp <- ggplot(mean_monthly_data, aes(x = month)) +
  ...
  scale_y_continuous(
    sec.axis = sec_axis(~ (. - 26) * 833 + 2000, name = expression("Mean Light Intensity " * (mu*mol~m^{-2}~s^{-1}))), name = "Mean Sea Surface Temperature (°C)",
...
ggsave("RAnalysis/output/environmental/mean.light.temp.jpg", light.temp , width = 10, height = 6)
