...
oogen2 <- oogen +
  geom_text(aes(x = replicate_id, y = 0, label = grand_tots), vjust = -0.5, size = 3, color = "black")
...
```{r}
# save oogenesis plot
ggsave("histology/output/oogenesis_abundance.pdf", oogen2 , width = 10, height = 6)
ggsave("histology/output/oogenesis_abundance.jpg", oogen2 , width = 10, height = 6)
...
oogen.size.plot2 <- oogen.size.plot +
  geom_text(aes(x = replicate_id, y = 0, label = count), vjust = -0.5, size = 3, color = "black")
...
```{r}
# save oogenesis plot
ggsave("histology/output/oogenesis_size.pdf", oogen.size.plot2 , width = 10, height = 6)
ggsave("histology/output/oogenesis_size.jpg", oogen.size.plot2 , width = 10, height = 6)
