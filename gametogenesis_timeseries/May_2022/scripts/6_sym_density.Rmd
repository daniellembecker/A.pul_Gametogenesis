...
```{r} 
# Cell count data
sym_counts <- read_csv("May_2022/data/6_sym_counts/6_symbiont_counts_data.csv")
...
metadata <- read_csv("May_2022/6_corals_sampled.csv") %>% select(1:4)
...
sym_counts %>%
  ...
  write_csv(path = "May_2022/output/6_sym_densities.csv")
