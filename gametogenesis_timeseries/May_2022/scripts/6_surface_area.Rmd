...
#load wax data
wax.data <- read.csv("May_2022/data/6_surface_area/6_surface_area_data.csv", header=TRUE)
...
summary(stnd.curve)$r.squared #r-squared = 0.995386
...
smpls%>%
  ...
  select(colony_id, surface.area.cm2, timepoint)%>%
    write_csv("May_2022//output/6_surface_area.calc.csv")
```
