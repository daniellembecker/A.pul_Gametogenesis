...
```{r} 
# Cell count data
sym_counts <- read_csv("June_2022/data/7_sym_counts/7_symbiont_counts_data.csv")
...
metadata <- read_csv("June_2022/7_corals_sampled.csv") %>% select(1:4)
...
sym_counts %>%
  ...
  write_csv(path = "June_2022/output/7_sym_densities.csv")
