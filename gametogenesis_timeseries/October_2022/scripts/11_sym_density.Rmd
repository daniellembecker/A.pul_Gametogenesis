...
```{r} 
# Cell count data
sym_counts <- read_csv("October_2022/data/11_sym_counts/11_symbiont_counts_data.csv")
...
metadata <- read_csv("October_2022/11_corals_sampled.csv") %>% select(1:4)
...
sym_counts %>%
  ...
  write_csv(path = "October_2022/output/11_sym_densities.csv")
