...
#load wax data
wax.data <- read.csv("April_2022/data/5_surface_area/5_surface_area_data.csv", header=TRUE)
...
summary(stnd.curve)$r.squared #r-squared = 0.99 20220324
...
smpls%>%
  ...
  select(colony_id, surface.area.cm2, timepoint)%>%
    write_csv("April_2022/output/5_surface_area.calc.csv")
```
