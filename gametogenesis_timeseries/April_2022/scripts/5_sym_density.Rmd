...
```{r} 
# Cell count data
sym_counts <- read_csv("April_2022/data/5_sym_counts/5_symbiont_counts_data.csv")
...
metadata <- read_csv("April_2022/5_corals_sampled.csv") %>% select(1:4)
...
sym_counts %>%
  ...
  write_csv(path = "April_2022/output/5_sym_densities.csv")
