...
```{r} 
# Cell count data
sym_counts <- read_csv("September_2022/data/10_sym_counts/10_symbiont_counts_data.csv")
...
metadata <- read_csv("September_2022/10_corals_sampled.csv") %>% select(1:4)
...
sym_counts %>%
  ...
  write_csv(path = "September_2022/output/10_sym_densities.csv")
