...
#load wax data
wax.data <- read.csv("gametogenesis_timeseries/December_2021/data/1_surface_area/1_surface_area_data.csv", header=TRUE)
...
summary(stnd.curve)$r.squared #r-squared = 0.99 20220306
...
smpls%>%
  mutate(timepoint="December2022")%>%
  select(colony_id, surface.area.cm2, timepoint)%>%
    write_csv("gametogenesis_timeseries/December_2021/surface.area.calc.csv")
```
