...
list<-levels(duplicates$code)
 ...
 master%>%
   filter(code %in% list)%>%
   write_csv(file="gametogenesis_timeseries_analysis/Output/timeseries_duplicates_qc.csv")
...
write_csv(master.1, "gametogenesis_timeseries_analysis/Output/master_timeseries.csv")
```
