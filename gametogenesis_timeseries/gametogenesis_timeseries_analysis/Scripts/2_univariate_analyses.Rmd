...
symbplot_cm2 <- filtered_sym %>%
  ...
  geom_text(data = timepoint_cld_sym, aes(label = .group, x = timepoint, y = 0.96 * max_cells_cm2), vjust = -0.5, size = 6, color = "black") +
...
chla_cm2 <- filtered_chla %>%
  ...
  ggplot(., aes(x = timepoint, y = chla.ug.cm2, fill = timepoint)) +
    ...
    geom_point(pch = 21, size=2, position = position_jitterdodge(0.2)) +
    ylim(0, 12)+
  geom_text(data = timepoint_cld_chla, aes(label = .group, x = timepoint, y = 1.0*max_chla), vjust = -0.5, size = 6, color = "black") +
  scale_x_discrete(limits = c("JAN","FEB","MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT")) +
    xlab("") + 
...
chlc_prot_cm2 <- master %>%
  ...
  ggplot(., aes(x = timepoint, y = chlc2.ug.cm2, fill = timepoint)) +
    ...
    geom_point(pch = 21, size=2, position = position_jitterdodge(0.2)) +
    ylim(0, 12)+
    geom_text(data = timepoint_cld_chlc, aes(label = .group, x = timepoint, y = 1.0*max_chlc), vjust = -0.5, size = 6, color = "black") +
  scale_x_discrete(limits = c("JAN","FEB","MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT")) +
    xlab("") + 
...
tot.chl <- master %>%
  ...
  ggplot(., aes(x = timepoint, y = Total_Chl_cm2, fill = timepoint)) +
    ...
    geom_point(pch = 21, size=2, position = position_jitterdodge(0.2)) +
    ylim(0, 12)+
      geom_text(data = timepoint_cld_tot, aes(label = .group, x = timepoint, y = 1.0*max_tot), vjust = -0.5, size = 6, color = "black") +
  scale_x_discrete(limits = c("JAN","FEB","MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT")) +
    xlab("") + 
