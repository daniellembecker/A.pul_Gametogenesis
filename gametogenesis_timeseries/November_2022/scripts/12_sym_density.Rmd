...
```{r} 
# Cell count data
sym_counts <- read_csv("March_2022/data/4_sym_counts/4_symbiont_counts_data.csv")
...
metadata <- read_csv("March_2022/4_corals_sampled.csv") %>% select(1:4)
...
sym_counts %>%
  ...
  write_csv(path = "February_2022/output/3_sym_densities.csv")
